...
-- Tab and indentation related options
vim.o.tabstop = 4
vim.o.softtabstop = 4
vim.o.shiftwidth = 4
...
-- Do not break lines that are too long, does not change buffer
vim.o.wrap = false
...
-- Delete and paste lines without overwriting registers
...
vim.keymap.set("v", "<leader>i", "V:call fsharp#sendSelectionToFsi()<cr><esc>")
